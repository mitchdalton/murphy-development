...
exports.handler = async event => {
  try {
    const accountInfo = await fetch('https://rest.sendinc.com/message.json?email=dalton05@gmail.com&recipients=dalton05@gmail.com&subject=will this work&message=hey what up', {
      method: 'POST', 
      headers: {
